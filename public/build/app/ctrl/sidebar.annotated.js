...
angular.module('fscApp')
  .controller('SidebarCtrl', ["$scope", "$location", "global", "$templateCache", "sync", "msgRegister", "constants", "dialog", "resourcePool", "$rootScope", function ($scope,$location,global,$templateCache,sync,

...
angular.module('fscApp')
    .factory('sidebar', ["$scope", "$location", "global", "$templateCache", "sync", "msgRegister", "constants", "dialog", "resourcePool", "utils", "msg", function ($scope,$location,global,$templateCache,sync,
